...
public class Db {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String users = "create table if not exists users(uid int(10) unsigned PRIMARY KEY AUTO_INCREMENT,utype varchar(20) NOT NULL,uname varchar(150) NOT NULL,uemail varchar(100) UNIQUE NOT NULL,udob varchar(20),uphno varchar(20),udate varchar(50) NOT NULL,upass varchar(100) NOT NULL) AUTO_INCREMENT=1;";
            ...
            String winners = "create table if not exists winners(wid int(10) unsigned PRIMARY KEY AUTO_INCREMENT,uit int(10) unsigned NOT NULL) AUTO_INCREMENT=1;";
