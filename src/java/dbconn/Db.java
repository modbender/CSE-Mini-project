...
public class Db {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String winners = "create table if not exists winners(wid int(10) unsigned PRIMARY KEY AUTO_INCREMENT,uid int(10) unsigned NOT NULL,foreign key (uid) references users(uid) on delete cascade) AUTO_INCREMENT=1;";
